# zyn macro(WIP(automated token collection))
...
**[Download Zyn Macro v1.0.4 (139 MB)](https://github.com/andrewzapps/zyn-macro/releases/latest)**
...
1. **Download** `zyn-macro-v1.0.4.zip` from [Releases](https://github.com/andrewzapps/zyn-macro/releases)
